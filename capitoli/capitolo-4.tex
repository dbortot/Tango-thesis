...
\\ \usecasepre{Il client invia una specifica richiesta al \emph{server}}
\\ \usecasedesc{Il \emph{server} elabora la richiesta del client e ne restituisce i risultati}
\\ \usecasepost{Il \emph{server} ha elaborato la richiesta ed inviato il responso al \emph{client}}
...
\usecaseactors{Client}
\\ \usecasepre{Il \emph{client} richiede l'elaborazione di un Point Cloud al \emph{server}}
\\ \usecasedesc{Il \emph{server} elabora il Point Cloud ricevuto e notifica l'esito al \emph{client}}
\\ \usecasepost{Il \emph{client} riceve l'esito dell'elaborazione dal \emph{server}}
...
\usecaseactors{Client}
\\ \usecasepre{Il \emph{client} richiede al \emph{server} l'invio di una specifica mesh}
\\ \usecasedesc{Il \emph{server} elabora la richiesta ricevuta ed invia la mesh desiderata al \emph{client}}
\\ \usecasepost{Il \emph{client} riceve la mesh richiesta dal \emph{server}}
...
\usecaseactors{Client}
\\ \usecasepre{Il \emph{client} richiede una lista di informazioni quali nome, data di creazione e volume delle mesh salvate su \emph{server}}
\\ \usecasedesc{Il \emph{server} elabora la richiesta ricevuta ed invia le informazioni al \emph{client}}
\\ \usecasepost{Il \emph{client} riceve le informazioni richieste dal \emph{server}}
