...
Tale rappresentazione, riferita spesso d'ora in poi con il più elegante termine inglese \emph{\gls{pc}}, è facilmente comprensibile all'utente se visualizzata come in figura \ref{fig:point_cloud_example}.
\begin{figure}[!h] 
    \centering 
